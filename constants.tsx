...
export const SUCCESS_STORIES: SuccessStory[] = [
  {
    id: 1,
    location: { ko: '중국 산시성 프로젝트', zh: '中国山西省项目' },
    title: { ko: '대규모 산업 오염 토양 복원', zh: '大规模工业污染土壤修复' },
    challenge: { ko: '장기적인 산업 오염 및 지력 저하로 농작물 생산성이 40% 이상 감소한 상태였습니다.', zh: '由于长期的工业污染和地力下降，农作物生产力下降了40%以上。' },
    solution: { ko: '특수 배양 미생물 토양개선제 투입 및 단계별 모니터링 시스템 구축.', zh: '投入特种培养微生物土壤改良剂并建立分阶段监测系统。' },
    result: { ko: '토양 내 유기물 함량 2.5배 증가 및 생태 건강성 완전 회복.', zh: '土壤中有机物含量增加2.5倍，生态健康完全恢复。' },
    imageUrl: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&q=80&w=800',
    metrics: [
      { label: { ko: '유기물 증가', zh: '有机物增加' }, value: '150%' },
      { label: { ko: '수확량 증대', zh: '产量增加' }, value: '35%' }
    ]
  },
  {
    id: 2,
    location: { ko: '국내 대형 급식소', zh: '韩国大型食堂' },
    title: { ko: '음식물 폐기물 자원 선순환', zh: '厨余垃圾资源良性循环' },
    challenge: { ko: '매일 발생하는 방대한 음식물 쓰레기의 높은 처리 비용과 환경 악취 문제.', zh: '每日产生的大量厨余垃圾处理成本高，且存在环境异味问题。' },
    solution: { ko: '동애등애 Bioconversion 시스템 도입을 통한 고단백 사료 및 비료 전환.', zh: '通过引入黑水虻生物转化系统，将其转化为高蛋白饲料和肥料。' },
    result: { ko: '폐기물 처리 비용 60% 절감 및 고품질 사료화 성공.', zh: '废物处理成本降低60%，并成功转化为高质量饲料。' },
    imageUrl: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=800',
    metrics: [
      { label: { ko: '비용 절감', zh: '成本降低' }, value: '60%' },
      { label: { ko: '자원 재활용', zh: '资源回收' }, value: '98%' }
    ]
  }
];

export const IMPACT_METRICS: MetricData[] = [
  { name: { ko: '토양 기능 개선', zh: '土壤功能改善' }, value: 85, unit: '%' },
  { name: { ko: '폐기물 처리량', zh: '废物处理量' }, value: 12000, unit: { ko: '톤/년', zh: '吨/年' } },
  { name: { ko: '처리 비용 절감', zh: '处理成本降低' }, value: 45, unit: '%' },
  { name: { ko: '부산물 활용률', zh: '副产品利用率' }, value: 92, unit: '%' }
];
